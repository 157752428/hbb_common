...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "fuda1234".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["122.247.76.226"];
pub const RS_PUB_KEY: &str = "GvvH8+x1VRrp28sLVE2GvOcQfEibpHt9oedQZv1J1yk=";
